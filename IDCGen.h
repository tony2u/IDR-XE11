...
public:
    ...
    void __fastcall MakeComment(int pos, AnsiString text);
    ...
    int __fastcall OutputVMTHeader(int pos, AnsiString vmtName);
...
{
public:
	__fastcall TSaveIDCDialog(TComponent* AOwner, LPTSTR TemplateName);
protected:
