...
DWORD (_stdcall* CchFormatInstr)(LPTSTR, DWORD);
DWORD (_stdcall* Dist)();
DWORD   *DIS;
LPTSTR  Reg8Tab[8] =
{
...
int __fastcall MDisasm::Init()
{
    ...
    CchFormatInstr = (DWORD (_stdcall*)(LPTSTR, DWORD))GetProcAddress(hModule, "?CchFormatInstr@DIS@@QBEIPADI@Z");
    Dist = (DWORD (_stdcall*)())GetProcAddress(hModule, "?Dist@DIS@@QBE?AW4DIST@1@XZ");
    DIS = PdisNew(1);
    return 1;
}
//---------------------------------------------------------------------------
BYTE __fastcall MDisasm::GetOp(LPTSTR mnem)
{
    DWORD   dd = *((DWORD*)mnem);
...
//---------------------------------------------------------------------------
int __fastcall MDisasm::GetOpType(LPTSTR Op)
{
    TCHAR c = Op[0];
    if (c == 0) return otUND;
...
//---------------------------------------------------------------------------
int __fastcall MDisasm::GetRegister(LPTSTR reg)
{
    for (int n = 0; n < 8; n++)
    {
...
//---------------------------------------------------------------------------
int __fastcall MDisasm::Disassemble(DWORD fromAdr, PDISINFO pDisInfo, LPTSTR disLine)
{
    int     _res;
...
//---------------------------------------------------------------------------
int __fastcall MDisasm::Disassemble(BYTE* from, __int64 address, PDISINFO pDisInfo, LPTSTR disLine)
{
	int	    InstrLen, _res;
	TCHAR    *p, *q;
    TCHAR    Instr[1024];
...
//---------------------------------------------------------------------------
void __fastcall MDisasm::FormatInstr(PDISINFO pDisInfo, LPTSTR disLine)
{
...
//---------------------------------------------------------------------------
int __fastcall MDisasm::OutputGeneralRegister(TCHAR *dst, int reg, int size)
{
BYTE        OperandSize;
...
//---------------------------------------------------------------------------
void __fastcall MDisasm::OutputHex(TCHAR *dst, DWORD val)
{
    BYTE    b;
    TCHAR    buf[12];
...
//---------------------------------------------------------------------------
void __fastcall MDisasm::OutputSegPrefix(LPTSTR dst, PDISINFO pDisInfo)
{
    BYTE    _segPrefix;
    TCHAR    *sptr = NULL;
...
//---------------------------------------------------------------------------
LPTSTR __fastcall MDisasm::GetSizeString(int size)
{
...
//---------------------------------------------------------------------------
void __fastcall MDisasm::OutputSizePtr(int size, bool mm, PDISINFO pDisInfo, LPTSTR disLine)
{
    LPTSTR   sptr = NULL;
...
//---------------------------------------------------------------------------
void __fastcall MDisasm::OutputMemAdr32(int argno, LPTSTR dst, DWORD arg, bool f1, bool f2, PDISINFO pDisInfo, LPTSTR disLine)
{
...
//---------------------------------------------------------------------------
void __fastcall MDisasm::OutputMemAdr16(int argno, LPTSTR dst, DWORD arg, bool f1, bool f2, PDISINFO pDisInfo, LPTSTR disLine)
{
...
//---------------------------------------------------------------------------
void __fastcall MDisasm::FormatArg(int argno, DWORD cmd, DWORD arg, PDISINFO pDisInfo, LPTSTR disLine)
{
