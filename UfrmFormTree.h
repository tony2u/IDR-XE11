...
__published:	// IDE-managed Components
    ...
    TMenuItem *Collapse1;
    TMenuItem *Find1;
    void __fastcall tvFormKeyPress(TObject *Sender, TCHAR &Key);
...
private:	// User declarations
    AnsiString MakeNodeCaption(TComponent* curCompo);
    AnsiString MakeNodeEventCaption(void* item);
    void BorderTheControl(TControl* aControl);

    void __fastcall AddEventsToNode(AnsiString compName, TTreeNode* dstNode, TList* evList);
    TTreeNode* __fastcall FindTreeNodeByText(TTreeNode* nodeFrom, const AnsiString& txt, bool caseSensitive);    
